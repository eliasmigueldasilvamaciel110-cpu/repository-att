...
hora1, minuto1, segundo1 = (int, input("Digite o primeiro horário (hora minuto segundo): ").split())
hora2, minuto2, segundo2 = (int, input("Digite o segundo horário (hora minuto segundo): ").split())
